...
**Repositório de Backend**: https://github.com/GiuZambot/back-integral-m05-desafio

**Repositório de Frontend**: https://github.com/GiuZambot/front-integral-m05-desafio

**URL da aplicação funcionando**: https://cobracubos.vercel.app/

---

E os itens abaixo, que deverão ser preenchidos apenas após a finalização de todas as sprints do projeto: 

**Pull Request (PR) de Backend**: https://github.com/cubos-academy/back-integral-m05-desafio/pull/15

**Pull Request (PR) de Frontend**: https://github.com/cubos-academy/front-integral-m05-desafio/pull/19
